CLASS zz_amount_in_words DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    "!
    "! @parameter IV_NUM | <p class="shorttext synchronized" lang="en"></p>
    "! @parameter iv_level | <p class="shorttext synchronized" lang="en"></p>
    "! @parameter RV_WORDS | <p class="shorttext synchronized" lang="en"></p>
...
CLASS ZZ_AMOUNT_IN_WORDS IMPLEMENTATION.
...
*    SELECT * FROM yy1_bo_amount_in_words INTO TABLE @DATA(lt_d).
...
*       This can be handled dynamically as well based on the requirement
        rv_words = |{ rv_words } { lv_dec_words } Cents Only |.
        CONDENSE rv_words.
      ENDIF.
      RETURN.
    ENDIF.
