CLASS zcl_truck_sheet_pdf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_TRUCK_SHEET_PDF IMPLEMENTATION.


  METHOD if_rap_query_provider~select.

  IF io_request->is_data_requested( ).
      DATA: lt_response TYPE TABLE OF ZCE_TRUCK_SHEET_PDF,
            ls_response TYPE ZCE_TRUCK_SHEET_PDF.
...
*      out->write( 'Dataservice initialized' ).
      ...
      lt_keys[ name = 'TRUCKSHEET_NO' ]-value = lv_truck_sheet_no.
