@ObjectModel: {
    query: {
       implementedBy: 'ABAP:ZCL_CLEARTAX_EINV'
    }
}

@UI.headerInfo: { typeName: 'E-WayBill Cancellation : ClearTax' ,
                  typeNamePlural: 'E-WayBill Cancellation : ClearTax' }


@EndUserText.label: 'E-WayBill Cancellation : ClearTax'
define root custom entity ZCE_CLEARTAX_EWAY_CANC
{
  @UI.facet: [{ id : 'VBELN',
            purpose: #STANDARD,
            type: #IDENTIFICATION_REFERENCE,
            label: 'E-WayBill Cancellation : ClearTax',
            position: 10 }]
